...
export default function ServicesSection() {
  const services = [
    {
      icon: "https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208559/service-1_utufj2.png?height=80&width=80",
      title: "Medicines",
      description:
    ...
    {
      icon: "https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208559/service-2_u9bphd.png?height=80&width=80",
      title: "HealthCare",
      description:
    ...
    {
      icon: "https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208559/service-3_wpxgqx.png?height=80&width=80",
      title: "Health Blog",
      description:
    ...
    {
      icon: "https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208607/service-4_wcn8mt.png?height=80&width=80",
      title: "Supplements",
      description:
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center my-6">
            ...
            <Image src="https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208556/4-dots_ufqucd.png?height=20&width=20" alt="Dots" width={20} height={20} className="mx-4" />
            <div className="h-0.5 w-32 bg-light-gray"></div>
          </div>
        </div>
          ...
          {services.map((service, index) => (
            <div key={index} className="text-center p-6">
              <div className="w-20 h-20 mx-auto mb-6">
                <Image src={service.icon || "https://res.cloudinary.com/dzj5xj6sq/image/upload/v1749208556/4-dots_ufqucd.png"} alt={service.title} width={80} height={80} />
              </div>
